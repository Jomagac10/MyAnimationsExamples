...
class LoadingView: UIView,CAAnimationDelegate {
    lazy var circle: CAShapeLayer = {
        let layer = circleShape(at: self.center, fillColor: UIColor(named: "Color1")!, strokeColor: .clear, radius: 110)
        return layer
    }()
    ...
    lazy var strokeLayer: CAShapeLayer = {
        let layer = circleShape(at: self.center, fillColor: .clear, strokeColor: UIColor(named: "Color2")!)
        layer.strokeEnd = 0
    ...
    lazy var pulseLayer: CAShapeLayer = {
        let layer = circleShape(at: self.center, fillColor: UIColor(named: "Color3")!, strokeColor: .clear)
        return layer
    }()
    ...
    func animatePulse() {
        ...
        strokeLayer.animation(forKey: "progressBarAnimation")?.delegate = self
    }
